    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-arena-black border-b border-arena-gold/10">
      <div className="px-4 sm:px-6 lg:px-8">
          ...
          {isLive ? (
            ...
            <div className={`hidden sm:flex items-center absolute ${pathname === "/calendario" || pathname === "/admin/outros/calendario" ? "left-[calc(50%+0.6em)] lg:left-[calc(50%+7rem+0.6em)]" : "left-1/2 lg:left-[calc(50%+7rem)]"} -translate-x-1/2 pointer-events-none`}>
