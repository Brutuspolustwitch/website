            ...
            <ArenaCard className="p-0 overflow-hidden">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-[family-name:var(--font-display)] text-lg text-arena-white font-bold tracking-wide">
              ...
              <div className="p-4">
                ...
                {tab === "treasury" && (
                  <div className="py-10 text-center space-y-3">
                    ...
                    <p className="text-arena-gold text-3xl font-bold font-[family-name:var(--font-display)]">
                      {totalWin.toFixed(2)}€
                    </p>
