...
const sections = [
  ...
  },
  {
    ...
    content: `Ao aceder ao site https://www.BRUTUSPOLUS.com, o utilizador terá acesso, na página inicial ("Home"), às ofertas de parceiros que temos disponíveis no momento (atualizadas conforme necessário). Damos acesso a um Leaderboard, onde os utilizadores poderão aceder mensalmente aos rankings de WAGER dos utilizadores afiliados nos casinos parceiros. Este ranking também é premiado mensalmente entre os primeiros utilizadores com maior Wager. A "Loja" é um conjunto de produtos virtuais oferecidos pelo BRUTUSPOLUS que podem ser comprados através de pontos virtuais ao assistir streams e participar em atividades no site. A loja oferece produtos como depósitos de casino, torneios, produtos eletrónicos, etc.`,
  },
  {
