...
const sections = [
  ...
  },
  {
    ...
    content: `Ao aceder ao site https://www.osecaadegas95.com, o utilizador terá acesso, na página inicial ("Home"), às ofertas de parceiros que temos disponíveis no momento (atualizadas conforme necessário). Damos acesso a um Leaderboard, onde os utilizadores poderão aceder mensalmente aos rankings de WAGER dos utilizadores afiliados nos casinos parceiros. Este ranking também é premiado mensalmente entre os primeiros utilizadores com maior Wager. A "Loja" é um conjunto de produtos virtuais oferecidos pelo OSECAADEGAS95 que podem ser comprados através de pontos virtuais ao assistir streams e participar em atividades no site. A loja oferece produtos como depósitos de casino, torneios, produtos eletrónicos, etc.`,
  },
  {
    title: "8. Dados de Fontes de Terceiros",
    content: `Podemos obter informações adicionais de fontes terceiras, como anunciantes, jogos ou serviços que usa, ou redes sociais (como Discord, Twitch) aos quais o nosso acesso foi aprovado. Quando acede aos nossos serviços através de redes sociais, ou quando conecta os nossos serviços às redes sociais, está a autorizar o OSECAADEGAS95 a recolher, armazenar e usar esta informação e conteúdo adicional de acordo com a política de privacidade. Usamos esta informação para complementar a informação que recolhemos sobre o utilizador de forma a fornecer experiências mais relevantes e seguras para o utilizador e melhorar os nossos serviços, análises e publicidade.`,
  },
  {
