...
export const ArenaButton = forwardRef<HTMLButtonElement, ArenaButtonProps>(
  function ArenaButton({ variant = "primary", size = "md", className = "", children, ...props }, ref) {
    const base =
      "relative inline-flex items-center justify-center font-[family-name:var(--font-display)] font-bold tracking-wider uppercase arena-btn-press arena-shine cursor-pointer";
