...
const tierAccents = {
  common: {
    ...
    badgeBg: "rgba(60, 44, 20, 0.82)",
    badgeText: "#e8d9b8",
    badgeBorder: "rgba(100,78,36,0.9)",
    glowColor: "transparent",
    ribbonColor: "var(--stone-mid)",
  },
  elite: {
    label: "ELITE",
    badgeBg: "rgba(130, 90, 0, 0.88)",
    badgeText: "#ffe99a",
    badgeBorder: "rgba(212,168,67,0.9)",
    glowColor: "rgba(212,168,67,0.06)",
    ribbonColor: "var(--gold-dark)",
  },
  legendary: {
    label: "TEMPO LIMITADO",
    badgeBg: "rgba(120, 14, 14, 0.9)",
    badgeText: "#ffd6d6",
    badgeBorder: "rgba(200,50,50,0.85)",
