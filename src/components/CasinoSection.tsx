            ...
            <motion.div key={casino.slug} variants={STAGGER_ITEM}>
              <ArenaCard variant="gold" className="p-6 h-full flex flex-col arena-shine">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="font-[family-name:var(--font-display)] text-xl font-bold text-arena-white">
                      {casino.name}
                    </h3>
                    <StarRating rating={casino.rating} />
                  </div>
                  <div className="bg-arena-crimson/20 border border-arena-crimson/30 px-3 py-1.5">
                    <p className="text-xs text-arena-gold font-[family-name:var(--font-display)] tracking-wider">
                      BONUS
                    </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4 flex-1">
                  <div>
                    <p className="text-xs text-arena-ash uppercase tracking-wider mb-2 font-[family-name:var(--font-display)]">
                      Pros
                    </p>
